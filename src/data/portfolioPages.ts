...
export const pages: Page[] = [
  ...
  },
  {
    ...
    nav: "Project",
    title: "ArbitrageBot",
    subtitle: "AI-Powered Cryptocurrency Arbitrage Detection System",
    label: "Final Year Project",
    description:
      "An AI-powered cross-exchange and triangular arbitrage detection platform with a TensorFlow ML pipeline, OpenAI API integration, CCXT exchange connectors, and a React.js live dashboard. Presented at iCOMET 2026.",
    chips: ["Python", "TensorFlow", "OpenAI API", "React.js", "CCXT", "SQLite"],
  ...
  },
  {
    ...
    nav: "Experience",
    title: "Experience",
    subtitle: "Frontend internship, project exhibition, and technical leadership",
    label: "Professional Activity",
    description:
      "Frontend developer internship at CodeAlpha (Remote), technical exhibition at iCOMET, and university creative leadership.",
    chips: ["CodeAlpha Intern", "Frontend Dev", "React.js", "iCOMET 2026"],
    cta: "See Experience",
